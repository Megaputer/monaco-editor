...
buildESM({
	...
	external: ['@megaputer/monaco-editor-core', '*/cssMode', '*/monaco.contribution']
});
buildAMD({
	base: 'language/css',
...
buildESM({
	...
	external: ['@megaputer/monaco-editor-core', '*/htmlMode', '*/monaco.contribution']
});
buildAMD({
	base: 'language/html',
...
buildESM({
	...
	external: ['@megaputer/monaco-editor-core', '*/jsonMode', '*/monaco.contribution']
});
buildAMD({
	base: 'language/json',
...
buildESM({
	...
	external: ['@megaputer/monaco-editor-core', '*/tsMode', '*/monaco.contribution']
});
buildAMD({
	base: 'language/typescript',
...
glob('../src/basic-languages/*/*.contribution.ts', { cwd: __dirname }, function (err, files) {
	...
	// ESM
	{
		...
		const external = ['@megaputer/monaco-editor-core', '*/_.contribution'];
