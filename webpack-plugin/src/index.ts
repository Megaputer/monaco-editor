...
} from '@megaputer/monaco-editor/esm/metadata';
...
function resolveMonacoPath(filePath: string, monacoEditorPath: string | undefined): string {
	...
	try {
		return require.resolve(path.join('@megaputer/monaco-editor/esm', filePath));
	} catch (err) {}

	try {
		return require.resolve(
			path.join(process.cwd(), 'node_modules/@megaputer/monaco-editor/esm', filePath)
		);
	} catch (err) {}
